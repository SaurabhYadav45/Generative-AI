...
def detect_query(state: State):
    ...
    system_prompt="""
    You're an AI assistant. Your job is to detect if user's query is related to coding questions or not.
...
def solve_coding_question(state:State):
    ...
    system_prompt = """
    You're an helpful AI assistant. Your job is to resolve the user query based on coding problem he's facing.
    """
